...
export default function install(Vue){
    ...
    // C2C original line, not suported by chrome 41
    ...
    // C2C original line, not suported by chrome 41
    // C2C but we don't need this filter
    ...
    // C2C : timeAgo filter, basiccly a shorthand for  moment.utc(someDate).local().fromNow()
