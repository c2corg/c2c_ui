<template>
  <div>
    <p>
      <strong
        >Yéti est une nouvelle application web destinée à améliorer la gestion du risque d’avalanche. Elle apporte une
    ...
    <ul>
      <li>
        Yéti propose <strong>une évaluation du risque d’avalanche sur une interface cartographique</strong>. Comme toute
      ...
      <li>
        Yéti est un outil de <strong>préparation de course à la maison</strong> qui utilise les principales informations
      ...
      <li>
        ...
        <strong>conditions</strong> et le <strong>terrain</strong> lors d’une préparation de course. Ces outils ne
        s’intéressent pas toutefois au <strong>groupe</strong> qui constitue le troisième facteur de risque en
      ...
      <li>
        ...
        <strong
          >Le pratiquant demeure seul responsable de sa planification, de ses choix et de sa conduite de course sur la
          neige</strong
        >
      </li>
      <li>
