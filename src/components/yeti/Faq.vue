<template>
  ...
  <div>
    ...
    <div class="question">
      ...
      <p>Yeti s’adresse à toutes les personnes soucieuses de gérer le risque d’avalanche au lieu de le subir. Pour tirer le meilleur parti de Yéti, il faut accepter de questionner ses intuitions et raisonner à partir de données objectives.</p>
    ...
    <div class="question">
      ...
      Saisir le potentiel de danger de 1 à 12.
    ...
    <div class="question">
      ...
      <p>L’application a d’abord été développée sous forme d’un démonstrateur sous le logiciel Qgis. Le développement a été assuré par des élèves ingénieurs et des enseignants-chercheurs de l’<a href="http://www.ensg.eu">ENSG-Géomatique</a> ainsi que par des développeurs du Géoportail de l’IGN.</p>
