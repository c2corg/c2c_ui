<template>
    <div class="modal associations-editor" :class="{'is-active':visible}">
        ...
        <content-box class="modal-content">
            <div class="columns is-multiline">
                ...
                <div class="column" v-if="validAssociations.waypoint!==undefined">
                ...
                <div class="column" v-if="validAssociations.route!==undefined">
                    <div class="title is-2" v-translate>
                        Routes
                    </div>
                ...
                <div class="column" v-if="validAssociations.article!==undefined">
                    <div class="title is-2" v-translate>
                        Articles
                    </div>
                ...
                <div class="column" v-if="validAssociations.xreport!==undefined">
                    <div class="title is-2" v-translate>
                        Xreport
                    </div>
                ...
                <div class="column" v-if="validAssociations.outing!==undefined">
                    <div class="title is-2" v-translate>
                        Outings
                    </div>
