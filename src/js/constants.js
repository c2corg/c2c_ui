...
function Field(name, properties){
    ...
    var fields = {
        ...
        */
        ...
        elevation_max:{type:"number", min:0, max:9000, unit:"m"},
        elevation_min:{type:"number", min:0, max:9000, unit:"m"},
        ...
        snow_quality:{values:common.attributes.condition_ratings},
        snow_quantity:{values:common.attributes.condition_ratings},
