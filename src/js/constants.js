...
function Field(name, properties){
    ...
    var fields = {
        ...
        activities:{values:attrs.activities, multiple, required, url:"act"},
        ...
        area_type:{values:attrs.area_types, required, url:"atyp"},
        article_categories:{name:"categories", values:attrs.article_categories, multiple, required, url:"acat"},
        ...
        event_type:{values:attrs.event_types, multiple, url:"xtyp"},
        ...
        quality:{values:attrs.quality_types, url:"qa"},
